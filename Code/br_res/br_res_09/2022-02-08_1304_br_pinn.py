...
def main():
    ...
    start = time.time()
    noise = 0.0
    savename = Path("br_res/br_res_09")
    ...
    var_list = pinn(
        ...
        var_modifier=[0.01, 1e-05, 0.0001],
        #m, h, j, Cai, d, f, x1, V
        ode_weights=[1e-1, 1e-1, 1e1, 1e0, 1, 1e1, 1e1, 1e-2],
        bc_weights=[1e-4, 1e-1, 1e1, 1e-1, 1e-3, 1e1, 1e2, 1e1],
        data_weights=[1, 1e-1, 1e-1, 1e-1, 1e-1, 1e-1, 1e-1, 1e-3],
