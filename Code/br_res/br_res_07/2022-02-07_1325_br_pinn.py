...
def main():
    ...
    start = time.time()
    noise = 0.0
    savename = Path("br_res/br_res_07")
    ...
    var_list = pinn(
        ...
        var_modifier=[0.01, 1e-05, 0.0001],
        #m, h, j, Cai, d, f, x1, V
        ode_weights=[.1*f for f in [1e-2, 1e-1, 1e-1, 1e-2, 1e-1, 1e-1, 1e-1, 1e-6]],
        bc_weights=[1e-3, 1e-2, 1e-2, 1e-2, 1e-5, 1e-4, 1e-4, 1e0],
        data_weights=[1e-1, 1e-1, 1e-2, 1e-1, 1e-5, 1e-4, 1e-2, 1e-2], #[1, 1, 1, 1, 1, 1, 1, 1],
