...
def main():
    ...
    for i in range(7,10):
        cur_res = run_pinn(states=[0], var=varses0[1], epochs=4e5, noise=noises[1], expe_n=i)
    ...
    #     # for nos in range(len(noises)):
    #     for i in range(10):
    #         cur_res = run_pinn(states=[0,1], var=varses0[varr], epochs=4e5, noise=noises[4], expe_n=i)
