...
def create_data(data_tt, data_y, var_trainable=[True, True, False, False], var_modifier=[-.25, 1.1, 20, 0.23]):
...
def main():
    ...
    noise = 0.0
    # tf.device("gpu")
    savename = Path("fhn_res/fitzhugh_nagumo_res_bas10_2_113")
    ...
    var_list = pinn(
        ...
        init_weights = [[3, 60], [.01, .01], [.2, 1]], # [[ode], [bc], [data]]
