...
def main():
    ...
    cur_res = run_pinn(states=[0,1], var=[True,True,True,True], epochs=5e5, noise=0.01)
    cur_res = run_pinn(states=[0], var=[False,True,True,False], epochs=4e5, noise=0.0)
    cur_res = run_pinn(states=[0], var=[False,True,True,False], epochs=3e5, noise=0.02)
